...
#define MAX_SPEED_BONUS 0.0f /* ~330BPM 1/4 streams */
#define MIN_SPEED_BONUS 0.0f /* ~200BPM 1/4 streams */
#define ANGLE_BONUS_SCALE 90
#define AIM_TIMING_THRESHOLD 100
#define SPEED_BONUS 0.25f
#define ACCURACY_BONUS 0.65f
#define AR_BONUS 1.1f
#define SPEED_ANGLE_BONUS_BEGIN (M_PI * 0.9f)
#define AIM_ANGLE_BONUS_BEGIN (M_PI / 3)
float decay_base[] = { 0.30f, 0.15f }; /* strains decay per interval */
...
int pp_std(ezpp_t ez) {
  ...
  acc_bonus = ACCURACY_BONUS + accuracy / 2.0f;
